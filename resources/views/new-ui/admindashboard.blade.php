...
<html>
  <head>
    ...
    <!-- Choices CSS-->
    <link rel="stylesheet" href="vendor/choices.js/public/new-ui-assets/assets/styles/choices.min.css">
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="new-ui-assets/assets/css/style.default.css" id="theme-stylesheet">
    <!-- Custom stylesheet - for your changes-->
    <link rel="stylesheet" href="assets/css/custom.css">
    <!-- Favicon-->
    <link rel="shortcut icon" href="new-ui-assets/assets/img/favicon.ico">
...
package-lock.json        <nav class="nav navbar py-3 px-0 shadow-sm text-white position-relative">
          <!-- Search Box-->
            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between w-100">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a class="navbar-brand d-none d-sm-inline-block" href="index.html">
                  ...
                  <div class="brand-text d-none d-sm-inline-block d-lg-none"><strong>TCF</strong></div></a>
        ...
        <nav class="side-navbar z-index-40">
          ...
          <div class="sidebar-header d-flex align-items-center py-4 px-3"><img class="avatar shadow-0 img-fluid rounded-circle" src="" alt="...">
            <div class="ms-3 title">
              <h1 class="h4 mb-2">Admin name</h1>
              <p class="text-sm text-gray-500 fw-light mb-0 lh-1">Admin role</p>
            </div>
          </div>
                  ...
                  <div class="row gx-5 bg-white">
                    ...
                    <div class="col-xl-3 col-sm-6 py-4 border-lg-end border-gray-200">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="mx-3">
                          <h6 class="h4 fw-light text-gray-600 mb-3">Number of<br>Clients</h6>
                          <div class="progress" style="height: 4px">
                            <div class="progress-bar " role="progressbar" style="width: 25%; height: 4px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-sm-6 py-4 border-lg-end border-gray-200">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="mx-3">
                          <h6 class="h4 fw-light text-gray-600 mb-3">Number <br>of<br>transactions</h6>
                          <div class="progress" style="height: 4px">
                            <div class="progress-bar" role="progressbar" style="width: 70%; height: 4px;" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                          </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-sm-6 py-4 border-lg-end border-gray-200">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="mx-3">
                          <h6 class="h4 fw-light text-gray-600 mb-3">Number of<br>Withdraws</h6>
                          <div class="progress" style="height: 4px">
                            <div class="progress-bar" role="progressbar" style="width: 40%; height: 4px;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                          </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-sm-6 py-4">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="mx-3">
                          <h6 class="h4 fw-light text-gray-600 mb-3">Number of<br>deposits</h6>
                          <div class="progress" style="height: 4px">
                            <div class="progress-bar " role="progressbar" style="width: 50%; height: 4px;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          </div>
                        </div>
              ...
              <div class="row align-items-stretch">
                ...
                <div class="col-lg-3 col-12">
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div class="icon flex-shrink-0"><i class="fas fa-tasks"></i></div>
                  ...
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div class="icon flex-shrink-0"><i class="far fa-calendar"></i></div>
                  ...
                  <div class="card mb-0">
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div class="icon flex-shrink-0 "><i class="far fa-paper-plane"></i></div>
                  ...
                  <div class="row align-items-center gx-lg-5 gy-3">
                    <div class="col-lg-6 border-lg-end">
                      <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center"><img class="img-fluid shadow-sm" src="assets/img/project-1.jpg" alt="..." width="50">
                          <div class="ms-3">
              ...
              <div class="card mb-3">
                <div class="card-body p-3">
                  <div class="row align-items-center gx-lg-5 gy-3">
                    <div class="col-lg-6 border-lg-end">
                      <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center"><img class="img-fluid shadow-sm" src="assets/img/project-2.jpg" alt="..." width="50">
                          <div class="ms-3">
                            <h3 class="h4 text-gray-700 mb-0">Project Title</h3><small class="text-gray-500">Lorem Ipsum Dolor</small>
                          </div>
                        </div><span class="text-sm text-gray-600 d-none d-sm-block">Today at 4:24 AM</span>
              ...
              <div class="card mb-3">
                <div class="card-body p-3">
                  <div class="row align-items-center gx-lg-5 gy-3">
                    <div class="col-lg-6 border-lg-end">
                      <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center"><img class="img-fluid shadow-sm" src="assets/img/project-3.jpg" alt="..." width="50">
                          <div class="ms-3">
                            <h3 class="h4 text-gray-700 mb-0">Project Title</h3><small class="text-gray-500">Lorem Ipsum Dolor</small>
                          </div>
                        </div><span class="text-sm text-gray-600 d-none d-sm-block">Today at 4:24 AM</span>
              ...
              <div class="card mb-0">
                <div class="card-body p-3">
                  <div class="row align-items-center gx-lg-5 gy-3">
                    <div class="col-lg-6 border-lg-end">
                      <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center"><img class="img-fluid shadow-sm" src="assets/img/project-4.jpg" alt="..." width="50">
                          <div class="ms-3">
                            <h3 class="h4 text-gray-700 mb-0">Project Title</h3><small class="text-gray-500">Lorem Ipsum Dolor</small>
                          </div>
                        </div><span class="text-sm text-gray-600 d-none d-sm-block">Today at 4:24 AM</span>
                ...
                <div class="col-lg-4">
                  <div class="card mb-0">
                    ...
                    <div class="card-body text-center">
                      <div class="client-avatar mb-3"><img class="img-fluid rounded-circle shadow-0" src="assets/img/avatar-2.jpg" alt="...">
                ...
                <div class="col-lg-6">
                  <div class="card mb-0">
                    ...
                    <div class="card-body p-0">
                      <div class="p-3 d-flex align-items-center"><img class="img-fluid rounded-circle p-1 border border-faintGreen flex-shrink-0" src="assets/img/avatar-1.jpg" alt="..." width="50">
                      ...
                      <div class="p-3 d-flex align-items-center bg-light"><img class="img-fluid rounded-circle p-1 border border-faintGreen flex-shrink-0" src="assets/img/avatar-2.jpg" alt="..." width="50">
                        <div class="ms-3"><a class="d-block" href="#">
                      ...
                      <div class="p-3 d-flex align-items-center"><img class="img-fluid rounded-circle p-1 border border-faintGreen flex-shrink-0" src="assets/img/avatar-3.jpg" alt="..." width="50">
                        <div class="ms-3"><a class="d-block" href="#">
                      ...
                      <div class="p-3 d-flex align-items-center bg-light"><img class="img-fluid rounded-circle p-1 border border-faintGreen flex-shrink-0" src="assets/img/avatar-4.jpg" alt="..." width="50">
                        <div class="ms-3"><a class="d-block" href="#">
                      ...
                      <div class="p-3 d-flex align-items-center"><img class="img-fluid rounded-circle p-1 border border-faintGreen flex-shrink-0" src="assets/img/avatar-5.jpg" alt="..." width="50">
                        <div class="ms-3"><a class="d-block" href="#">
                    ...
                    <div class="card-body p-0">
                      ...
                      <div class="p-3 border-bottom border-gray-200">
                        <div class="d-flex justify-content-between">
                          <div class="d-flex"><a class="flex-shrink-0" href="#"><img class="img-fluid rounded-circle" src="assets/img/avatar-5.jpg" alt="person" width="50"></a>
                            <div class="ms-3">
                              <h5>Aria Smith</h5>
                      ...
                      <div class="p-3 border-bottom border-gray-200">
                        <div class="d-flex justify-content-between">
                          <div class="d-flex"><a class="flex-shrink-0" href="#"><img class="img-fluid rounded-circle" src="assets/img/avatar-2.jpg" alt="person" width="50"></a>
                            <div class="ms-3">
                      ...
                      <div class="p-3">
                        <div class="d-flex justify-content-between">
                          <div class="d-flex"><a class="flex-shrink-0" href="#"><img class="img-fluid rounded-circle" src="assets/img/avatar-3.jpg" alt="person" width="50"></a>
                            <div class="ms-3">
                              <h5>Ashley Wood</h5>
                              <p class="mb-0 text-xs text-gray-600 lh-1">Posted a new blog</p><small class="text-gray-600 fw-light">Today 5:60 pm - 12.06.2014</small>
                            </div>
    ...
    <script src="vendor/choices.js/public/new-ui-assets/assets/scripts/choices.min.js"></script>
    <script src="new-ui-assets/assets/js/charts-home.js"></script>
    <!-- Main File-->
    <script src="new-ui-assets/assets/js/front.js"></script>
    <script>
      // ------------------------------------------------------- //
      //   Inject SVG Sprite - 
      //   see more here 
